...
class CategoryHeaderView: UIView {
    ...
    func setUpView() {
        ...
        imageView.image = #imageLiteral(resourceName: "zhu-hongzhi-eT_rrCbvcqg-unsplash")
        ...
        let imageConstraints:[NSLayoutConstraint] = [
         ...
         //   articleIcon.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: 6),
            articleIcon.topAnchor.constraint(equalTo: titleLabel.bottomAnchor , constant: 8),
            articleIcon.widthAnchor.constraint(equalToConstant: 40),
            articleIcon.heightAnchor.constraint(equalToConstant: 40)
        ]
        NSLayoutConstraint.activate(imageConstraints)
        articleIcon.image = #imageLiteral(resourceName: "willian-justen-de-vasconcellos-lrPBS8b4G14-unsplash")
    }
